...
const Stats = () => {
    ...
    return (
        <div className=' container mx-auto '>
            ...
            {
                noData ? <div className="flex flex-col items-center justify-center min-h-112.5 bg-linear-to-b from-transparent to-gray-50 rounded-3xl p-12 text-center border border-gray-100 shadow-inner">
